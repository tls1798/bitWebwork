			...
			<div class="col-md-12">
				...
				<form method="post">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<%=bean.getEname() %>" name="ename" id="ename" placeholder="ename" />
					</div>
					<div class="form-group">
						<label for="sal">sal</label>
						<input type="text" class="form-control" value="<%=bean.getSal() %>" name="sal" id="sal" placeholder="sal" />
					</div>
					<div class="form-group">
						<label for="hiredate">hiredate</label>
						<input type="datetime" class="form-control" value="<%=bean.getHiredate() %>" name="hiredate" id="hiredate" placeholder="hiredate" readonly/>
					</div>
					<div class="form-group">
						<label for="job">job</label>
						<input type="text" class="form-control" value="<%=bean.getJob() %>" name="job" id="job" placeholder="job" />
					</div>
