...
try{
	...
	out.print("<div class=\"err\">오류발생<div class=\"btn\">x</div>");
}
%>
<nav>
	<ul>
...
<div class="container">
	<div class="row">
		...
		<form method="post">
			...
			<div>
				<label for="empno">empno</label>
				<input type="text" name="empno" id="empno" value="<%=param[1]==null?"":param[1] %>"/>
			</div>
			<div>
				<label for="empno">empno</label>
				<input type="text" name="empno" id="empno" value="<%=param[2]==null?"":param[2] %>"/>
			</div>
			<div>
