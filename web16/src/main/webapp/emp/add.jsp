			...
			<div class="page-header">
				...
				<form class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="empno" placeholder="empno" value="<%=request.getParameter("empno")==null?"":request.getParameter("empno") %>">
						</div>
					</div>
					<div class="form-group">
						<label for="ename" class="col-sm-2 control-label">ename</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="ename" placeholder="ename" value="<%=request.getParameter("ename")==null?"":request.getParameter("ename") %>">
						</div>
					</div>
					<div class="form-group">
						<label for="sal" class="col-sm-2 control-label">sal</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="sal" placeholder="sal" value="<%=request.getParameter("sal")==null?"":request.getParameter("sal") %>">
						</div>
					</div>
					<div class="form-group">
