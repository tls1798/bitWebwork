				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="https://dummyimage.com/600x400/555/fff&text=01"/>
						</div>
						<div class="item">
							<img src="https://dummyimage.com/600x400/555/fff&text=02"/>
						</div>
						<div class="item">
							<img src="https://dummyimage.com/600x400/555/fff&text=03"/>
						</div>
					</div>
				</div>
			<!-- content end -->
